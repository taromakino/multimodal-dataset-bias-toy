...
def main(config):
    ...
    data_train, data_val, data_test = make_data(seed, config.n_examples, config.input_dim, config.origin_offset,
        config.x_sd, config.temperature, True, False, config.batch_size, config.n_workers)
